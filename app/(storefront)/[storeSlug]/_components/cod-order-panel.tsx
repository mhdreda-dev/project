...
export function CodOrderPanel({ product, storeSlug, whatsAppUrl }: Props) {
  ...
  const modal = open ? (
    ...
    >
      <div className="relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-3xl border border-white/10 bg-[#0b0a09] text-white shadow-2xl shadow-black/70 sm:max-w-xl">
        <button
          type="button"
